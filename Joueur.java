...
public class Joueur {
    ...
    public Joueur(int x, int y, int numero) {
        ...
        // images perso 1
        perso1face = Toolkit.getDefaultToolkit().getImage("./images/perso1face.png");
        perso1dos = Toolkit.getDefaultToolkit().getImage("./images/perso1dos.png");
        perso1gauche = Toolkit.getDefaultToolkit().getImage("./images/perso1gauche.png");
        perso1droite = Toolkit.getDefaultToolkit().getImage("./images/perso1droite.png");

        // images perso 2
        perso2face = Toolkit.getDefaultToolkit().getImage("./images/perso2face.png");
        perso2dos = Toolkit.getDefaultToolkit().getImage("./images/perso2dos.png");
        perso2gauche = Toolkit.getDefaultToolkit().getImage("./images/perso2gauche.png");
        perso2droite = Toolkit.getDefaultToolkit().getImage("./images/perso2droite.png");
    }
    ...
    public void collision(Cellule liste[][]) {
        ...
        if (ligne - 1 >= 0 && colonne - 1 >= 0 && ligne + 1 <= 10 && colonne + 1 <= 12) {
            // collision verticale
            if (liste[ligne - 1][colonne].symb == "#" || liste[ligne - 1][colonne].symb == "t"
                    || liste[ligne - 1][colonne].symb == "b") {
                if (y < (liste[ligne - 1][colonne].y + liste[ligne - 1][colonne].larg))
                    y = (liste[ligne - 1][colonne].y + liste[ligne - 1][colonne].larg);
            }
            ...
            if (liste[ligne][colonne - 1].symb == "#" || liste[ligne][colonne - 1].symb == "t"
                    || liste[ligne][colonne - 1].symb == "b") {
                if (x < (liste[ligne][colonne - 1].x + liste[ligne][colonne - 1].larg))
                    x = (liste[ligne][colonne - 1].x + liste[ligne][colonne - 1].larg);
            }
